...
--
-- Host: localhost
-- Generation Time: Oct 20, 2016 at 04:08 AM
...
('it454', 'IT 454', '', '', 5, ''),
('it500', 'IT 500', 'New Testing', 'Editing my cool class', 3, 'Edit Testing'),
('it207', 'IT 207', 'Web Programming with JavaScript', 'Introduces students to JavaScript, a powerful programming language for creating dynamic, interactive web pages. Students learn the basics of JavaScript, and apply it toward the development of a website. Topics include language constructs and syntax, event-driven programming, manipulating the Document Object Model (DOM), form validation, and utilizing JavaScript libraries, such as jQuery.', 5, 'IT 102 or instructor permission'),
('it250', 'IT 250', 'IT250', 'My cool description', 5, 'IT249'),
('it251', 'IT 251', 'IT251', 'Another cool description', 5, 'IT250');
...
(115, 1, 'it114', 'aas-fall-freshman-fallStart', 'n', ''),
(116, 1, 'it135', 'aas-fall-freshman-fallStart', 'n', ''),
(117, 1, 'it131', 'aas-spring-freshman-fallStart', 'n', ''),
(133, 1, 'cmst338', 'bas-software-spring-senior-fallStart', 'n', ''),
(135, 1, 'engl335', 'bas-software-winter-junior-fallStart', 'n', ''),
(134, 1, 'it486', 'bas-software-spring-senior-fallStart', 'n', ''),
(121, 1, 'it305', 'bas-software-fall-junior-fallStart', 'n', ''),
(122, 1, 'it201', 'aas-winter-freshman-fallStart', 'n', ''),
(123, 1, 'it301', 'bas-software-fall-junior-fallStart', 'n', ''),
(124, 1, 'it328', 'bas-software-winter-junior-fallStart', 'n', ''),
(125, 1, 'it333', 'bas-software-winter-junior-fallStart', 'n', ''),
(132, 1, 'it372', 'bas-software-spring-junior-fallStart', 'n', ''),
(127, 1, 'it405', 'bas-software-spring-junior-fallStart', 'n', ''),
(128, 1, 'it355', 'bas-software-fall-senior-fallStart', 'n', ''),
(129, 1, 'it426', 'bas-software-fall-senior-fallStart', 'n', ''),
(130, 1, 'it434', 'bas-software-winter-senior-fallStart', 'n', ''),
(131, 1, 'it485', 'bas-software-winter-senior-fallStart', 'n', ''),
(136, 1, 'it301', 'bas-software-winter-junior-winterStart', 'n', ''),
(137, 1, 'it305', 'bas-software-winter-junior-winterStart', 'n', ''),
(138, 1, 'it328', 'bas-software-spring-junior-winterStart', 'n', ''),
(139, 1, 'it333', 'bas-software-spring-junior-winterStart', 'n', ''),
(140, 1, 'engl335', 'bas-software-spring-junior-winterStart', 'n', ''),
(141, 1, 'it405', 'bas-software-summer-junior-winterStart', 'n', ''),
(142, 1, 'it355', 'bas-software-summer-junior-winterStart', 'n', ''),
(143, 1, 'it426', 'bas-software-fall-senior-winterStart', 'n', ''),
(144, 1, 'it372', 'bas-software-spring-junior-fallStart', 'n', ''),
(145, 1, 'it434', 'bas-software-winter-senior-winterStart', 'n', ''),
(146, 1, 'it485', 'bas-software-winter-senior-winterStart', 'n', ''),
(147, 1, 'it486', 'bas-software-spring-senior-winterStart', 'n', ''),
(148, 1, 'cmst338', 'bas-software-spring-senior-winterStart', 'n', ''),
(149, 1, 'it160', 'aas-winter-freshman-fallStart', 'n', ''),
(150, 1, 'it141', 'aas-winter-freshman-fallStart', 'n', '');
...
--
ALTER TABLE `scheduled_courses`
  MODIFY `scid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=152;--
